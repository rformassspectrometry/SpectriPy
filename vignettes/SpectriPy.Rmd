...
```{r}
mapping <- spectraVariableMapping(pythonLibrary = "matchms")
mapping
```
...
```{r}
sps_r <- pyspec_to_rspec(x = res, pythonLibrary = "matchms", spectraVariables = spectraVariableMapping("matchms"))
