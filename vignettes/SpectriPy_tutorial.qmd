...
Here, we calculate the pairwise similarity between the query spectra and the
reference library spectra using R's Spectra. FINDME!!! TODO NOT OK

Firs, we setuo and load the requirements for MS2DeepScore to work.
...
Once the Python environment is ready, we can load the pre-trained 
MS2DeepScore model.
