...
object. We thus first ensure that the package *msdata* is installed. If the line
below results in an error you need to first install *msdata* using
`BiocManager::install("msdata")`.

```{r}
stopifnot(require("msdata"))
```
