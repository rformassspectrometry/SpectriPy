...
installation or usage of a pre-defined or system Python environment.
...
- NOTE: still define SPECTRIPY_ENV/"spectripy.env"? maybe to be used in `import`
  parameter `delay_load`?
