...
*SpectriPy* will install also all required Python libraries using *miniconda*
(which will also installed if not already available) into a new Python
environment *r-spectripy*. See also section @sec-python for options to skip this
and use either *virtualenv* or system Python environment instead.
...
*SpectriPy* will use *miniconda* to setup and use a package-specific
