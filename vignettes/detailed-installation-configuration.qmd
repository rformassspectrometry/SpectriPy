...
Python. By default, *SpectriPy* uses *miniconda* to configure and setup a Python
environment specific to the package. The code below shows how *miniconda* can be
