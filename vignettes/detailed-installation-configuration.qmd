...
Python. By default, *SpectriPy* uses Python's *virtualenv* to configure and
setup a Python environment specific to the package. Alternatively, also
*miniconda* can be used instead. The code below shows how *miniconda* can be
