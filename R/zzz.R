...
## #'
## #' @importFrom reticulate use_condaenv conda_create conda_list
## #'
## #' @noRd
...
##     use_condaenv(envname, required = FALSE)
...
## #'
## #' @importFrom reticulate virtualenv_exists virtualenv_create use_virtualenv
## #'
## #' @noRd
